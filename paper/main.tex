...
\begin{tabular}{c | c c}
    \hline\hline
    \rotatebox{90}{(a). Detection scores}
...
For the $n$-bit addition function,...

For the $n$-bit less-than comparison,...

For the $n$-bit Beaver triple generation function,...
